...
a Turn-Based Battle game made entirely in java, totally not inspired by a certain other IP. Created as a Systems &amp; UX considerations project & to practice writing documentation on an old project
...
This project is a turn-based battle game built to explore **state-driven UI design**, **event sequencing**, and **safe input handling** in an event-driven environment.
